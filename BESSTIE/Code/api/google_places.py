...
def main() -> None:
    ...
    # Load place types
    place_types_path = Path("/Users/nicholasguntoro/Desktop/GitHub/BESSTIE/Dataset/place_types.json")
    try:
    ...
    # Go up to project root, then into Dataset/Cities
    project_root = current_dir.parent.parent  # adjust if needed
    cities_dir = project_root / "Dataset" / "Cities"
